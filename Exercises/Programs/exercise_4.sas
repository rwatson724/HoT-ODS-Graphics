/****************************************************************************************
*** Program:    exercise4b.sas
*** Output:     N/A
*** Purpose:    Produce Bar Chart with Table with LAYOUT GRIDDED (outside) with GTL
...
footnote "GTL - Inset Table Component Using GRIDDED (Outside)";
proc template;
...
proc sgrender data = OUTD.TRTPCT template = recrgrphe;
