...
/********** JOSH - NEED TO SEE IF THERE IS A WAY TO DO A GRID IN SGPLOT ***************/
/*
...
footnote "SGPLOT - Inset Table Component Using GRIDDED";
...
goptions device = png;
ods pdf notoc dpi = 300 file = "&outdir.ex&fnmprt._barchart_gtl2.pdf";
ods rtf image_dpi = 300 file = "&outdir.ex&fnmprt._barchart_gtl2.rtf";
title "Bar Chart by Treatment for Percent of Patients with Dermatologic Event - &fnmprt";
...
proc sgrender data = trtpct template = recrgrphd;
  format TRTAN trt. pct_row pctfmt.; 
run;
